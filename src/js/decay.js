...
particle_settings['muon'    ] = new particle_settings_object(mMu , 1, 'rgb(255,100,100)', '\u03BC', 2, 0.95*Sr, 1) ;
particle_settings['electron'] = new particle_settings_object(mEl , 1, 'rgb(  0,200,  0)', 'e'     , 2, 0.51*Sr, 6) ;
particle_settings['photon'  ] = new particle_settings_object(mPh , 0, 'rgb(  0,  0,  0)', '\u03B3', 2, 0.51*Sr,-4) ;
particle_settings['tau'     ] = new particle_settings_object(mMu , 1, 'rgb(150, 57,239)', '\u03C4', 2, 0.65*Sr, 4) ;
particle_settings['pion'    ] = new particle_settings_object(mPi , 1, 'rgb(  0,  0,  0)', '\u03BE', 2, 0.65*Sr,-4) ;
...
function alert_probs(topos, probs){
  var text = '' ;
  for(var i=0 ; i<topos.length ; i++){
    text += (100*probs[i]).toPrecision(3) + '% ' + topos[i] + '\n' ;
  }
  alert(text) ;
}
...
var VVH_decay_array = [
  ['signal'     , [ [ 1.0 , ['HBoson']] ]] ,
  ['background' , [ [ 1.0 , ['ZBoson','ZBoson']], [1.0, ['WBoson','WBoson']], [ 1.0 , ['ZBoson']], [1.0, ['WBoson']] ]] ,
  ['HBoson'     , [ [ 2.79e-2, ['ZBoson','ZBoson']], [2.24e-1, ['WBoson','WBoson']], [1.59e-3, ['ZBoson','photon']] , [6.22e-2, ['unstableTau','unstableTau']], [2.16e-4, ['muon'  ,'muon']] ]] ,
  ['ZBoson'     , [ [ 1.0 , ['unstableTau', 'unstableTau']], [1.0, ['muon','muon']] , [1.0, ['electron','electron']] ]] ,
  ['WBoson'     , [ [ 1.0 , ['unstableTau']], [1.0, ['muon']] , [1.0, ['electron']] ]] ,
  ['unstableTau', [ [17.84, ['electron']], [17.36, ['muon']] , [67.0, ['tau']] ]] ,
  ['tau'     , []] ,
